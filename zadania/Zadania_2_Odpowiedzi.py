...
class Moneta(arcade.Sprite):
    ...
    def update(self):
        ...
        że odbiją się więcej razy niż będzie na to wskazywała zmienna MAKSYMALNA_LICZBA_ODBIC"""
        if self.liczba_odbic > MAKSYMALNA_LICZBA_ODBIC:
            self.kill()
